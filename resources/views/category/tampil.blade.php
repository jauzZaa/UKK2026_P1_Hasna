        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex gap-2 align-items-center">
                    <form method="GET" action="{{ route('category.tampil') }}" class="d-flex">
                        <div class="input-group input-group-sm">
                            ...
                            @if(request('search'))
                            <a href="{{ route('category.tampil') }}" class="btn btn-outline-secondary">
                    ...
                    <a href="{{ route('category.tambah') }}" class="btn btn-sm btn-primary">
