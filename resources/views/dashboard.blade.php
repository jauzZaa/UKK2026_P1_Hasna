                    ...
                    <table class="table table-hover table-nowrap mb-0 align-middle table-check">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="fw-medium">#DK1018</td>
                                <td>1 Jun, 11:21</td>
                                <td>
                                    <div class="d-flex">
                                        <div class="me-2"><i class="mdi mdi-check-circle-outline text-success"></i></div>
                                        <div>
                                            <p class="mb-0">Paid</p>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h5 class="font-size-14 text-truncate mb-0"><a href="#" class="text-reset">Alex Fox</a></h5>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="flexCheckDefaultexample"></label>
                                    </div>
                                </td>
                                <td class="fw-medium">#DK1010</td>
                                <td>27 Apr , 10:53</td>
                                <td>
                                    <div class="d-flex">
                                        <div class="me-2"><i class="mdi mdi-check-circle-outline text-success"></i></div>
...
<script>
    // =============================================
    // SPARKLINE CHART 1 - Total Revenue (Area)
    // =============================================
    ...
    new ApexCharts(document.querySelector("#sparkline-chart-1"), sparkline1Options).render();

    // =============================================
    // SPARKLINE CHART 2 - Total Refunds (Area)
    // =============================================
    var sparkline2Options = {
        series: [{
            data: [35, 53, 23, 60, 44, 33, 52, 20, 45, 30, 40]
        }],
        chart: {
            type: 'area',
            height: 60,
    ...
    new ApexCharts(document.querySelector("#sparkline-chart-2"), sparkline2Options).render();

    // =============================================
    // SPARKLINE CHART 3 - Active Users (Bar)
    // =============================================
    var sparkline3Options = {
        series: [{
    ...
    new ApexCharts(document.querySelector("#sparkline-chart-3"), sparkline3Options).render();

    // =============================================
    // SPARKLINE CHART 4 - All Time Orders (Bar)
    // =============================================
    var sparkline4Options = {
        series: [{
            data: [47, 45, 74, 14, 56, 73, 45, 63, 18, 9, 15]
        }],
        chart: {
            type: 'bar',
            height: 60,
    ...
    new ApexCharts(document.querySelector("#sparkline-chart-4"), sparkline4Options).render();

    // =============================================
    // SALES ANALYTICS CHART (Line + Column)
    // =============================================
    var salesAnalyticsOptions = {
        series: [{
                name: 'Income',
                type: 'column',
    ...
    new ApexCharts(document.querySelector("#sales-analytics-chart"), salesAnalyticsOptions).render();
    ...
    new ApexCharts(document.querySelector("#donut_chart"), donutOptions).render();
